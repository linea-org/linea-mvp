    ...
    <div className="space-y-4">
      ...
      {(op === 'format' || op === 'parse') && (
        <>
          <div className="space-y-1.5">
            ...
            />
            <p className="text-[10px] text-muted-foreground">Variable holding the date string or timestamp</p>
          </div>
          {op === 'format' && (
            <div className="space-y-1.5">
              <Label>Output format</Label>
          ...
          {op === 'parse' && (
            <p className="text-[10px] text-muted-foreground">
              Returns: <code>iso</code>, <code>unix</code>, <code>year</code>, <code>month</code>, <code>day</code>, <code>hour</code>, <code>minute</code>, <code>second</code>, <code>weekday</code>
            </p>
          )}
        </>
      )}
      ...
      {op === 'diff' && (
        <>
          ...
          <p className="text-[10px] text-muted-foreground">
            Returns B - A in: <code>milliseconds</code>, <code>seconds</code>, <code>minutes</code>, <code>hours</code>, <code>days</code>, <code>weeks</code>
          </p>
        </>
      )}
    </div>
