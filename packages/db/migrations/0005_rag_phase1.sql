...
-- Note: CONCURRENTLY cannot run inside a transaction block (used by drizzle migrate).
-- Use the plain form here; on a live production table, run this separately outside a transaction.
