            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border bg-muted/30">
                  <th className="w-5 px-3 py-1.5 text-left text-[10px] font-semibold tracking-wide text-muted-foreground uppercase"></th>
                  <th className="px-3 py-1.5 text-left text-[10px] font-semibold tracking-wide text-muted-foreground uppercase">
                    Node
                  </th>
                  <th className="px-3 py-1.5 text-left text-[10px] font-semibold tracking-wide text-muted-foreground uppercase">
                    Status
                  ...
                  return (
                    <>
                      ...
                      >
                        ...
                        <td
                          className={`px-3 py-1.5 font-medium capitalize ${log.level === "error" ? "text-red-500" : "text-green-600"}`}
                        >
                      ...
                      {isExpanded && hasOutput && (
                        ...
                        >
                          <td colSpan={5} className="px-3 py-2">
                            <pre className="max-h-32 overflow-y-auto font-mono text-[10px] break-all whitespace-pre-wrap text-foreground">
                              {log.data?.error
                                ? log.data.error
