...
export function LoopPanel({ data, onUpdate, nodes = [], nodeId }: LoopPanelProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <Label>Item transform <span className="text-muted-foreground">(optional)</span></Label>
        <Input
          ref={transformRef}
          value={itemTransform}
        ...
        />
        <p className="text-xs text-muted-foreground">
          JS expression evaluated per element. Use <code>item</code> for the current element.
          Leave blank to collect the array as-is.
        </p>
      </div>
