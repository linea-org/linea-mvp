    ...
    <div className="space-y-4">
      <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-900 dark:bg-amber-950/30">
        <p className="text-[11px] font-semibold text-amber-700 dark:text-amber-400">
          Node currently disabled
        </p>
        <p className="mt-0.5 text-[11px] leading-snug text-amber-600 dark:text-amber-500">
          Arbitrary code execution requires a dedicated Pod VM (Kata Containers
          / Firecracker) for safe sandboxing. This node will throw at runtime
          until Pod VM infrastructure is available. Use the{" "}
          <strong>Agent</strong> node for logic-heavy steps in the meantime.
        </p>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[11px] text-muted-foreground">
          Runs in a sandboxed Node.js vm. Return a value to set this node&apos;s
          output. Async functions are not supported.
        </p>
      </div>
