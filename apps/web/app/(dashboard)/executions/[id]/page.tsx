  ...
  async function loadData() {
    ...
    try {
      ...
      const [ex, logRows] = await Promise.all([
        api.get<Execution>(`/workspaces/${activeWorkspace.id}/executions/${id}`),
        api.get<ExecutionLog[]>(`/workspaces/${activeWorkspace.id}/executions/${id}/logs`),
      ]);
      setExecution(ex);
      setLogs(logRows);
      return ex;
