            ...
            <TableBody>
              {paginated.map((ex) => (
                <TableRow
                  ...
                  onClick={() =>
                    router.push(`/pods/${podId}/executions/${ex.id}`)
                  }
                >
                  <TableCell>
                    <Badge variant={STATUS_VARIANT[ex.status] ?? "secondary"}>
                      {ex.status}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-sm">
                    {ex.workflowId
                      ? (workflowNames[ex.workflowId] ??
