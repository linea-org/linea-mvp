  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <h1 className="font-mono text-sm">{execution.id}</h1>
        ...
        <div className="ml-auto flex gap-2">
          ...
          {execution.workflowId && (
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push(`/pods/${podId}/workflows/${execution.workflowId!}`)}
            >
              Open in builder
            </Button>
          )}
      ...
      {execution.status === 'suspended' && (
        <>
          ...
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 space-y-3">
            <p className="text-sm font-semibold text-yellow-900">Awaiting approval</p>
            <p className="text-xs text-yellow-800">
              This execution is paused at an approval node. Review the input/output above and approve or reject.
            </p>
            <Textarea
              rows={2}
