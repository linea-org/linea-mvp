    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[11px] text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 font-mono">item</code> for the current element and{' '}
          <code className="rounded bg-muted px-1 font-mono">index</code> for its position.
        </p>
      </div>
